 ...
 *
 * Given an integer n, replace its bits starting from the bit at position a to the bit at position b, inclusive, with the bits of integer k.
 * Count from the least significant bit to the most significant bit, starting from 0.
