 ...
 * We are given a personal information string S, which may represent either an email address or a phone number.
 ...
 To mask an email, all names must be converted to lowercase and all letters between the first and last letter of the first name mustbe replaced by 5 asterisks '*'.
...
public class MaskingPersonalInformation831 {
    ...
    private String maskEmail(String s, int i) {
    ...
    private String maskPhone(String s) {
        ...
        for(int i = s.length()-1, j = 0; j < 4; i--) {
